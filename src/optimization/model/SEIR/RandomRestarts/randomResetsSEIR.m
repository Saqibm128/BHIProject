...
for i = 1:numRestarts
    ...
    [res, error] = findOptBetaEpsilGammaInitial(trueInfected, trueExposed, trueRecovered, [nLiberia, 0, 1, 0], [alpha, beta, epsilon]);
    ...
    [res, error] = findOptBetaEpsilGammaInitial(trueInfected, trueExposed, trueRecovered, [nGuinea, 0, 1, 0], [alpha, beta, epsilon]);
    ...
    [res, error] = findOptBetaEpsilGammaInitial(trueInfected, trueExposed, trueRecovered, [nSierraLeone, 0, 1, 0], [alpha, beta, epsilon]);
...
csvwrite('BetaEpsilGammaErrorsGuineaNaturalPop.csv', betaEpsilGammaErrorGuineaPop);
csvwrite('BetaEpsilGammaErrorsEpsilLiberiaPopNaturalPop.csv', betaEpsilGammaErrorLiberia);
csvwrite('BetaEpsilGammaErrorsEpsilSierraLeonePopNaturalPop.csv', betaEpsilGammaErrorSierraLeone);