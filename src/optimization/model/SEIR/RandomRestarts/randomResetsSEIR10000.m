function randomResetsSEIR10000()
...
for i = 1:numRestarts
    ...
    [res, error] = findOptBetaEpsilGammaInitial(trueInfected, trueExposed, trueRecovered, [10000, 0, 1, 0], [alpha, beta, epsilon]);
...
csvwrite('BetaEpsilGammaErrorsGuineaNaturalPop10000.csv', betaEpsilGammaErrorGuineaPop);
csvwrite('BetaEpsilGammaErrorsEpsilLiberiaPopNaturalPop10000.csv', betaEpsilGammaErrorLiberia);
csvwrite('BetaEpsilGammaErrorsEpsilSierraLeonePopNaturalPop10000.csv', betaEpsilGammaErrorSierraLeone);